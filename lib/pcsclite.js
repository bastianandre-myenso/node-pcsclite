...
// Load prebuilt addon binding binary for the current platform
let pcsclite;
let platform;
...
try {
	pcsclite = require(`../prebuilt/${platform}/pcsclite.node`);
} catch (error) {
	console.error('Error loading prebuilt pcsclite bindings. Trying alternative.');
	try {
		pcsclite = require(`../prebuilt/${platform}/pcsclite--alt.node`);
	} catch (error) {
		console.error('Error loading alternative pcsclite bindings. Usind natively rebuilt one.');
